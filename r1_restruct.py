...
class Restructor:
    ...
    def s_02_city(self, e, set):
        if set in ["rm", "bj"]:
            return self.get_city(e[5])
        elif set == "oc":
            return self.get_city_oc(e[5])
        elif set == "zhand":
            return self.return_after_input(e, "City ")
    ...
    def s_02_district(self, e, set):
        if set == "rm":
            return self.get_district_rm(e[3])
        elif set == "bj":
            return self.get_district_bj(e[5])
        elif set == "oc":
            return self.get_district_oc(e[5])
        elif set == "zhand":
            return self.return_after_input(e, "District ")
    ...
    def s_02_address(self, e, set):
        if set == "rm":
            return self.get_address_rm(e[5])
        elif set == "bj":
            return self.get_address_bj(e[5])
        elif set == "oc":
            return self.get_address_oc(e[5])
        elif set == "zhand":
            return self.return_after_input(e, "Address ")
    ...
    def s_03_min_lease(self, e, set):
        if set == "rm":
            ...
            return self.return_after_input(e, "Minimalny okres najmu ").replace("lata", "years").replace("lat",
                                                                                                         "years").replace(
                "rok", "year")
        elif set == "zhand":
            return ""
    ...
    def s_04_building_status(self, e, set):
        ...
        if set == "rm":
            ...
            return self.translate(result=self.return_after_input(e, "Status budynku"),
                                  translate_dict=translate_dict_status)
    ...
    def s_04_total_net_space(self, e, set):
        if set == "rm":
            ...
            return self.return_digit(
                (e[self.get_index_based_on_input(e, "Total net rentable office".lower())]).replace("m²", "m2"))
        elif set == "oc":
    ...
    def s_04_total_gross_space(self, e, set):
        if set == "rm":
            ...
            return self.return_digit(e[self.get_index_based_on_input(e, "Total building space".lower())]).replace("m²",
                                                                                                                  "m2")
        elif set == "oc":
    ...
    def s_04_completion_date(self, e, set):
        if set == "rm":
            ...
            return "{} {}".format(self.return_after_input(e, "Completion quater "),
                                  self.return_after_input(e, "Completion year "))
    ...
    def s_04_no_underground_parking(self, e, set):
        if set == "rm":
            return self.return_digit(
                e[self.get_index_based_on_input(e, "Number of underground parking spaces".lower())])
        elif set == "bj":
            return ""
        elif set == "oc":
    ...
    def s_04_parking_ratio(self, e, set):
        if set == "rm":
            return self.return_digit(e[self.get_index_based_on_input(e, "Parking ratio".lower())]).replace("place ",
                                                                                                           "").replace(
                " of the leased space", "")
        elif set == "bj":
            return self.return_digit(e[self.get_index_based_on_input(e, "Parking ratio".lower())]).replace("/",
                                                                                                           "per").replace(
                "sq m", "m2")
        elif set == "oc":
    ...
    def s_05_sprinklers(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Smoke detectors".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="Tryskacze".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_access_control(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Access control".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="BMS".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_computer_cabling(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Computer cabling".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="Kable światłowodowe".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_switchboard(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Telephone cabling".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="Kable światłowodowe".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_smoke_detectors(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Czujniki dymu".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_suspended_ceiling(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Suspended ceiling".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="Podwieszane sufity".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_openable_windows(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Openable windows".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="Uchylne okna".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_partition_walls(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Wall partitioning".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="Podnoszone podłogi".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_backup_power_supply(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Emergency power supply".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="aaaa".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_power_cabling(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Power cabling".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="Kable światłowodowe".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_air_conditioning(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Air conditioning".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="Klimatyzacja".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_raised_floor(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Raised floor".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="Podnoszone podłogi".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_carpeting(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Carpeting".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="".lower())
        elif set == "zhand":
            return ""
    ...
    def s_05_fibre_optic_connections(self, e, set):
        if set == "rm":
            ...
            return self.return_true_if_input(e, input="Fiber optics".lower())
        elif set == "oc":
            return self.return_true_if_input(e, input="Kable światłowodowe".lower())
        elif set == "zhand":
            return ""
